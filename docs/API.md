...
```
network.vonix.guardian:vonixguardian-core:1.4.0
```
...
dependencies {
    ...
    compileOnly('network.vonix.guardian:vonixguardian-core:1.4.0') { transitive = false }
}
```
...
dependencies {
    ...
    compileOnly 'network.vonix.guardian:vonixguardian-core:1.4.0'
}
```
...
| `String pluginVersion()`                                                        | Human-readable mod version (`"1.4.0"`).          |
