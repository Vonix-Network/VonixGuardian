...
```
network.vonix.guardian:vonixguardian-core:1.3.12
```
...
dependencies {
    ...
    compileOnly('network.vonix.guardian:vonixguardian-core:1.3.12') { transitive = false }
}
```
...
dependencies {
    ...
    compileOnly 'network.vonix.guardian:vonixguardian-core:1.3.12'
}
```
...
| `String pluginVersion()`                                                        | Human-readable mod version (`"1.3.12"`).          |
