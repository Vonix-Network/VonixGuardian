...
**Current candidate (r55 release successor, 2026-08-25):** VonixGuardian 1.4.1 at the successor commit pinned by Hermes evidence on baseline `505cee04099152d7144b241c69140b4e9204cd9a`, with the r54 Terra migration-barrier race repaired by serializing queue removal, worker-state publication, and idle inspection under one pipeline-state lock, plus deterministic poll-handoff and quarantine interleaving regressions. Nine loader cells (Fabric/Forge 1.18.2–1.20.1, Fabric/NeoForge 1.21.1, NeoForge 26.1). Schema **v8**. CoreProtect reference pin remains public tag `v24.0` commit `b5f534fd2c735c6f094cda8ca50a66324e81b048`.
...
## Current state (r55) — do not invent remaining v24 features
