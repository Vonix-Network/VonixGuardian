...
**Current candidate (r51 release successor, 2026-08-25):** VonixGuardian 1.4.1 at the successor commit pinned by Hermes evidence on baseline `505cee04099152d7144b241c69140b4e9204cd9a`, with the r50 Terra blockers repaired in the successor candidate. Nine loader cells (Fabric/Forge 1.18.2–1.20.1, Fabric/NeoForge 1.21.1, NeoForge 26.1). Schema **v8**. CoreProtect reference pin remains public tag `v24.0` commit `b5f534fd2c735c6f094cda8ca50a66324e81b048`.
