...
import network.vonix.guardian.mc.v1_20_1.forge.bridge.ForgePreLogBridge;
import org.slf4j.Logger;
import org.slf4j.LoggerFactory;

/**
 * Forge 1.20.1 mod entrypoint.
 */
@Mod("vonixguardian")
public final class VonixGuardianForge {
    ...
    public VonixGuardianForge() {
        LOG.info(Guardian.MARKER, "VonixGuardian (Forge 1.20.1) loading.");
