...
import network.vonix.guardian.mc.v1_21_1.fabric.bridge.FabricPreLogBridge;
import org.slf4j.Logger;
import org.slf4j.LoggerFactory;

/**
 * Fabric 1.21.1 server entrypoint. Wires the bootstrap + event registrations
...
public final class VonixGuardianFabric implements DedicatedServerModInitializer {
    ...
    public void onInitializeServer() {
        LOG.info(Guardian.MARKER, "VonixGuardian (Fabric 1.21.1) loading.");
        try {
