...
import network.vonix.threadedhorizons.common.config.updater.Updaters;
...
public class ThreadedHorizonsConfig {

    static final Logger LOGGER = LoggerFactory.getLogger("Threaded Horizons Config");
    ...
    static {
        ...
        final Supplier<CommentedFileConfig> configSupplier = () -> CommentedFileConfig.builder(LoaderHooks.getConfigDir().resolve("threadedhorizons.toml"))
                .autosave()
        ...
        globalExecutorParallelism = ConfigUtils.getValue(configScope, "globalExecutorParallelism", ThreadedHorizonsConfig::getDefaultGlobalExecutorParallelism, "Configures the parallelism of global executor", List.of(), null, true);
    ...
    public static class IoSystemConfig {
        ...
        private static final boolean global_replaceImpl = Boolean.parseBoolean(System.getProperty("network.vonix.threadedhorizons.common.config.ioSystemConfig.replaceImpl", "false"));
    ...
    public static class ThreadedWorldGenConfig {
        ...
        // For Testing Purposes
        private static final boolean global_enabled = Boolean.parseBoolean(System.getProperty("network.vonix.threadedhorizons.common.config.threadedWorldGen.enabled", "false"));
        private static final boolean global_useGlobalBiomeCache = Boolean.parseBoolean(System.getProperty("network.vonix.threadedhorizons.common.config.threadedWorldGen.useGlobalBiomeCache", "false"));
        private static final boolean global_reduceLockRadius = Boolean.parseBoolean(System.getProperty("network.vonix.threadedhorizons.common.config.threadedWorldGen.reduceLockRadius", "false"));
...
//            this.useGlobalBiomeCache = ConfigUtils.getValue(configScope, "useGlobalBiomeCache", () -> false, "(DO NOT USE in 1.18) \n Whether to enable global BiomeCache to accelerate worldgen \n This increases memory allocation ", List.of(), false, true);
    ...
    public static class AsyncSchedulingConfig {
        private static final boolean global_enabled = Boolean.parseBoolean(System.getProperty("network.vonix.threadedhorizons.common.config.asyncScheduling.enabled", "false"));
...
//            this.enabled = ConfigUtils.getValue(configScope, "enabled", () -> true, "Whether to enable this feature \n (may cause incompatibility with other mods)", List.of(), false, true);
                ...
                this.mode = ConfigUtils.getValue(configScope, "mode", () -> Mode.ENHANCED,
                        """
                                Defines how auto save should be handled \s
                                 ...
                                 ENHANCED: Use Threaded Horizons enhanced auto-save (auto-save performed when the server have spare time after ticking) \s
    ...
    public static class NoTickViewDistanceConfig {
        private static final boolean global_enabled = Boolean.parseBoolean(System.getProperty("network.vonix.threadedhorizons.common.config.noTickViewDistance.enabled", "false"));
