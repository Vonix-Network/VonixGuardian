...
import network.vonix.guardian.mc.v1_18_2.forge.bridge.ForgePreLogBridge;
import org.slf4j.Logger;
import org.slf4j.LoggerFactory;

/**
 * Forge 1.18.2 mod entrypoint.
 */
@Mod("vonixguardian")
public final class VonixGuardianForge {
    ...
    public VonixGuardianForge() {
        LOG.info(Guardian.MARKER, "VonixGuardian (Forge 1.18.2) loading.");
