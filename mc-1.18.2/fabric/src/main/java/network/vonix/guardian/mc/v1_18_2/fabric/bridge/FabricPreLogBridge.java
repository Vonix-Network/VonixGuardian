 ...
 */
package network.vonix.guardian.mc.v1_18_2.fabric.bridge;
...
/**
 * Fabric 1.18.2 native-bus adapter for {@link PreLogEvent}.
 *
 * <p>Fabric doesn't have a bus-cancellation contract — instead each event is
 * a listener chain returning an {@link InteractionResult}. We fire {@link #PRE_LOG}
 * and treat any {@link InteractionResult#FAIL} as a veto; {@link InteractionResult#PASS}
 * (or {@link InteractionResult#SUCCESS}) lets the action through.</p>
 *
 * @since 1.2.0 (W4-09)
 */
